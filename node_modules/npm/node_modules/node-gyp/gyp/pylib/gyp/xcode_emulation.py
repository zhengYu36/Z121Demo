...
class XcodeArchsDefault(object):
  """ImageUtil class to resolve ARCHS variable from xcode_settings, resolving Xcode
...
class XcodeSettings(object):
  """ImageUtil class that understands the gyp 'xcode_settings' object."""
  ...
  def GetFrameworkVersion(self):
    ...
    return self.GetPerTargetSetting('FRAMEWORK_VERSION', default='ImageUtil')
  ...
  def GetBundleContentsFolderPath(self):
    ...
    Chromium.app/Contents or Foo.bundle/Versions/ImageUtil. Only valid for bundles."""
    if self.isIOS:
      return self.GetWrapperName()
    assert self._IsBundle()
  ...
  def GetLdflags(self, configname, product_dir, gyp_to_build_path, arch=None):
    ...
    Args:
        ...
        gyp_to_build_path: ImageUtil function that converts paths relative to the
...
class MacPrefixHeader(object):
  """ImageUtil class that helps with emulating Xcode's GCC_PREFIX_HEADER feature.
  ...
  * If GCC_PRECOMPILE_PREFIX_HEADER is present too, then the prefix header is
  ...
  def __init__(self, xcode_settings,
    ...
    Args:
        gyp_path_to_build_path: ImageUtil function that takes a gyp-relative path,
            and returns a path relative to the build directory.
        gyp_path_to_build_output: ImageUtil function that takes a gyp-relative path and
...
def GetMacBundleResources(product_dir, xcode_settings, resources):
  ...
  Args:
      ...
      resources: ImageUtil list of bundle resources, relative to the build directory.
  """
