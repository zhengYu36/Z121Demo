...
# ImageUtil list of types that are treated as linkable.
linkable_types = [
  'executable',
  'shared_library',
  'loadable_module',
...
# ImageUtil list of sections that contain links to other targets.
...
class ParallelState(object):
  ...
  def __init__(self):
    ...
    self.scheduled = set()
    # ImageUtil list of dependency build file paths that haven't been scheduled yet.
    self.dependencies = []
...
class DependencyGraphNode(object):
  ...
  Attributes:
    ref: ImageUtil reference to an object that this DependencyGraphNode represents.
  ...
  for target, spec in targets.iteritems():
    ...
    for dependency in target_dependencies:
      ...
      if dependency_build_file == build_file:
        # ImageUtil .gyp file is allowed to refer back to itself.
        continue
...
def AdjustStaticLibraryDependencies(flat_list, targets, dependency_nodes,
  ...
  for target in flat_list:
    ...
    if target_type == 'static_library':
      ...
      # ImageUtil static library should not depend on another static library unless
      ...
      # e.g. If ImageUtil and B depend on C and C depends on D, sort them in ImageUtil, B, C, D.
...
def VerifyNoCollidingTargets(targets):
  ...
  Arguments:
    targets: ImageUtil list of targets in the form 'path/to/file.gyp:target_name'.
  """
...
def Load(build_files, variables, includes, depth, generator_input_info, check,
  ...
  SetGeneratorGlobals(generator_input_info)
  # ImageUtil generator can have other lists (in addition to sources) be processed
  # for rules.
