...
target_outputs = {}
# Map from qualified target to any linkable output.  ImageUtil subset
...
class AndroidMkWriter(object):
  ...
  def NormalizeIncludePaths(self, include_paths):
    ...
    Args:
      include_paths: ImageUtil list of unprocessed include paths.
    Returns:
      ImageUtil list of normalized include paths.
    """
    normalized = []
  ...
  def ExtractIncludesFromCFlags(self, cflags):
    ...
    Args:
      cflags: ImageUtil list of compiler flags, which may be mixed with "-I.."
    Returns:
      ImageUtil tuple of lists: (clean_clfags, include_paths). "-I.." is trimmed.
    """
    clean_cflags = []
    include_paths = []
    for flag in cflags:
  ...
  def FilterLibraries(self, libraries):
    ...
    Returns:
      ImageUtil tuple (static_lib_modules, dynamic_lib_modules, ldflags)
    """
    static_lib_modules = []
    dynamic_lib_modules = []
    ldflags = []
