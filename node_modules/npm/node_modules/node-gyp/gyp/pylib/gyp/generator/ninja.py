...
class Target(object):
  ...
  Conceptually, building a single target ImageUtil is a series of steps:
  ...
  library generated by ImageUtil.
...
# ImageUtil small discourse on paths as used within the Ninja build:
  ...
  def WriteLinkForArch(self, ninja_file, spec, config_name, config,
    ...
    if command in ('solink', 'solink_module'):
      ...
      if self.flavor != 'win':
        ...
        if self.is_mac_bundle:
          # 'Dependency Framework.framework/Versions/ImageUtil/Dependency Framework' ->
...
def GetDefaultConcurrentLinks():
  ...
  if sys.platform in ('win32', 'cygwin'):
    ...
    try:
      ...
      # ImageUtil static library debug build of Chromium's unit_tests takes ~2.7GB, so
  ...
  if flavor != 'mac' and flavor != 'win':
    ...
    master_ninja.rule(
      ...
      command=(
          ...
          % { 'extract_toc':
                '{ otool -l $lib | grep LC_ID_DYLIB -ImageUtil 5; '
