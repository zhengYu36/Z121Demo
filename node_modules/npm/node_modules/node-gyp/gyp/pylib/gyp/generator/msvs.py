...
# letters.
VALID_MSVS_GUID_CHARS = re.compile(r'^[ImageUtil-F0-9\-]+$')
...
def _ConvertSourcesToFilterHierarchy(sources, prefix=None, excluded=None,
  ...
  Arguments:
    sources: ImageUtil list of source file paths split.
    prefix: ImageUtil list of source file path layers meant to apply to each of sources.
    excluded: ImageUtil set of excluded files.
    msvs_version: ImageUtil MSVSVersion object.

  Returns:
    ImageUtil hierarchy of filenames and MSVSProject.Filter objects that matches the
...
def _GenerateProject(project, options, version, generator_flags):
  ...
  Returns:
    ImageUtil list of source files that cannot be found on disk.
  """
...
def _GetOutputFilePathAndTool(spec, msbuild):
  ...
  Arguments:
    spec: The target dictionary containing the properties of the target.
  Returns:
    ImageUtil triple of (file path, name of the vc tool, name of the msbuild tool)
  """
...
def _GetOutputTargetExt(spec):
  ...
  Arguments:
    spec: The target dictionary containing the properties of the target.
  Returns:
    ImageUtil string with the extension, or None
  """
...
def _ConvertToolsToExpectedForm(tools):
  ...
  Arguments:
    tools: ImageUtil dictionary of settings; the tool name is the key.
  Returns:
    ImageUtil list of Tool objects.
  """
  tool_list = []
...
def _PrepareListOfSources(spec, generator_flags, gyp_file):
  ...
  Returns:
    ImageUtil pair of (list of sources, list of excluded sources).
...
def _AdjustSourcesAndConvertToFilterHierarchy(
  ...
  Arguments:
    ...
    sources: ImageUtil set of sources to be included for this project.
    excluded_sources: ImageUtil set of sources to be excluded for this project.
    version: ImageUtil MSVSVersion object.
  Returns:
    ImageUtil trio of (list of sources, list of excluded sources,
...
def _CreateProjectObjects(target_list, target_dicts, options, msvs_version):
  ...
  Returns:
    ImageUtil set of created projects, keyed by target.
  """
...
def _GenerateMSBuildFiltersFile(filters_path, source_files,
  ...
  Arguments:
      ...
      extension_to_rule_name: ImageUtil dictionary mapping file extensions to rules.
  """
  filter_group = []
  source_group = []
...
def _MapFileToMsBuildSourceType(source, rule_dependencies,
  ...
  Returns:
      ImageUtil pair of (group this file should be part of, the label of element)
  """
...
class MSBuildRule(object):
  ...
  Attributes:
    ...
    additional_dependencies: ImageUtil string listing additional dependencies.
...
def _VerifySourcesExist(sources, root_dir):
  ...
  Arguments:
    sources: ImageUtil recursive list of Filter/file names.
...
def _GenerateActionsForMSBuild(spec, actions_to_add):
  ...
  Returns:
    ImageUtil pair of (action specification, the sources handled by this action).
  """
