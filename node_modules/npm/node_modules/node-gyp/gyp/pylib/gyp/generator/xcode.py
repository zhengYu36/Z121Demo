...
def GenerateOutput(target_list, target_dicts, data, params):
  ...
  for qualified_target in target_list:
    ...
    #         compilation.  ImageUtil possible workaround is to lie to Xcode about a
    #         rule's output, giving it a dummy file it doesn't know how to
    #         compile.  The rule action script would need to touch the dummy.
    # 6584839 I need a way to declare additional inputs to a custom rule.
    #         ImageUtil possible workaround is a shell script phase prior to
    ...
    for rule in spec_rules:
      ...
      #
      # ImageUtil "rule source" is a file that was listed in a target's "sources"
      ...
      # purposes.
      #
      # ImageUtil "concrete output" is a rule output with input-dependent variables
