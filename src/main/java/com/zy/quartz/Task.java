...
public class Task {
     ...
     * @Title: QuartzManager.java
     */
    public void addJob(Scheduler sched, String jobName, String jobGroupName, String triggerName,
     ...
     * @Title: QuartzManager.java
     */
    public void removeJob(Scheduler sched, String jobName, String jobGroupName, String triggerName,
